export function AscensionIslandFlag({ className = 'h-4 w-4' }: { className?: string }) {
  return (
    ...
    >
      ...
      ></path>
      <path stroke="#000" strokeWidth=".4" d="m543.6 276.7 5-19.2c.8-2-1.1-2.3-1.9 0l-5 19.2z"></path>
      <path
        fill="#fff"
        stroke="#000"
        strokeWidth=".4"
      ...
      ></path>
      <path fill="#fff" stroke="#000" strokeWidth=".4" d="m512.3 206.7-23.5.4z"></path>
      <path
        stroke="#000"
        strokeWidth=".4"
