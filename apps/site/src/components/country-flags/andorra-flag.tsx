  ...
  return (
    ...
    >
      ...
      <g fill="none" stroke="#703d29">
        ...
        ></path>
        <path strokeWidth=".8" d="M319.7 329.1c-.3 1.7-1.9 3.6-5.3 4.2l-.6.2"></path>
        <path
          strokeWidth=".9"
          d="M404.2 276.2a18.3 18.3 0 0 1 5.6 13.5c0 3.6-1 7.5-2 9.4-.8 1.7-3 9-15.3 14a85 85 0 0 1-25.6 4c-10.3.3-19.8.7-25.4 7.3"
        ></path>
        <path strokeWidth=".6" d="M387.5 282.9c.8-1 3.5-2.4 5.8-1.1a6.2 6.2 0 0 1 2.3 2"></path>
        <path strokeWidth=".9" d="m401.6 273.8 1.4.5a7 7 0 0 0 4 0c2.8-.8 4.6-3.4 3.2-6.9a6 6 0 0 0-1.8-2.1"></path>
        <path
          strokeLinecap="round"
          strokeWidth=".7"
          d="M240.3 199.8c-2 1.1-3.3 1.4-4.8 3.1a28.1 28.1 0 0 0-2.6 6.8m46-51.7c0 1.8-1.2 2.8-3 3.2"
        ></path>
        <path strokeWidth=".6" d="M397.1 192a19 19 0 0 1 18.6 19.8c0 16-9.9 18.5-13.8 19.6"></path>
        <path strokeWidth=".7" d="M398.4 192c8.1-.3 16.5 5.7 16.9 20.7.3 11.7-8 17-12 18"></path>
        <path
          strokeWidth=".6"
        ...
        ></path>
        <g strokeWidth=".6">
          <path strokeLinecap="round" d="M254.3 224a6.9 6.9 0 0 1-2.1 1.4m150.5 44.8.5.2c1.4.8 4.2-.2 3.4-2.4"></path>
          ...
          <path strokeLinecap="round" d="M314.4 332.6a10 10 0 0 1-2.2 4.2"></path>
          ...
          <path strokeLinecap="round" d="m306.7 163.7 2.3-1.3c1-.6 2.3-.5 2.9.2.6.7.7 2-.2 2.8"></path>
          ...
          <path strokeLinecap="round" d="M243.8 202.4c1.5.8 3.1-.4 2.8-2.4a2.9 2.9 0 0 0-2.5-2.2"></path>
          ...
          <path strokeLinecap="round" d="m340.2 327.8.7.8.2.9c.3 1.5-.7 2.4-2 2.6-1.6.2-2.8-.8-3.3-2"></path>
          ...
          <path strokeLinecap="round" d="M251.5 236.4c4 5.1 6.3 8.1 6.4 14.1.1 5.7-1.7 9.6-5 13.7"></path>
          ...
          <path strokeLinecap="round" d="M257.8 203.2c-.9 3-3.5 6.6-8.6 7.9-2.4.6-5.6-.2-6.6-1"></path>
          ...
          <path strokeLinecap="square" d="M397 198.3c6.9 1.6 9.3 7.8 9.3 13.8 0 4.9-.5 11.6-10 13.9"></path>
          ...
          <path strokeLinecap="round" d="M387.6 236.4c-4 5.1-6.3 8.1-6.4 14.1 0 5.7 1.7 9.6 5.1 13.7"></path>
          ...
          <path strokeLinecap="round" d="M244.7 259.4a16.5 16.5 0 0 1-6.3 6"></path>
          ...
          <path strokeLinecap="round" d="M253 189.8c-.3 1.3-1 2.9-3 2.7"></path>
        ...
        <g stroke="#c7b37f" strokeLinecap="round" strokeWidth=".6">
          ...
          <path strokeLinecap="butt" d="m254.2 225-1.2.5a5.1 5.1 0 0 1-1.5.3"></path>
      ...
      <g transform="matrix(.64 0 0 .64 0 16)">
        ...
        <g id="b">
          ...
          <g fill="none" stroke="#fedf00" strokeLinecap="round">
            ...
            <path strokeLinecap="butt" d="m560.1 369.8.4-.3a8.2 8.2 0 0 0 2.7-1.8"></path>
