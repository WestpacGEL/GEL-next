      ...
      <Grid>
        ...
        {filteredLogos.map(({ key, Logo }) => (
          <GridItem key={key} span={{ initial: 12, sm: 6, md: 4, lg: 3 }} className="flex">
            <div className="border-border-muted-soft bg-background-white-pale xsl:mb-4 mb-2 flex grow flex-col items-center justify-center rounded-2xl border px-2 pt-6 pb-3">
