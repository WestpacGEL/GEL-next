...
export const Icons = () => {
  ...
  return (
    <div>
      <div className="border-border-muted-soft bg-background-white-pale mb-4 flex flex-wrap gap-3 rounded-md border p-4 align-bottom">
      ...
      <Grid>
        ...
        {filteredIcons.map(({ key, Icon }) => (
          <GridItem key={key} span={{ initial: 12, sm: 3, lg: 2 }}>
            <div className="border-border-muted-soft bg-background-white-pale mb-2 flex flex-col items-center justify-center rounded-md border px-2 pb-3 pt-6 xsl:mb-4">
