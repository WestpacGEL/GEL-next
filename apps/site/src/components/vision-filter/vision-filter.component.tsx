    ...
    <>
      ...
      >
        <defs>
          ...
          <filter id="tritanomaly" colorInterpolationFilters="sRGB">
          ...
          <filter id="achromatomaly" colorInterpolationFilters="sRGB">
          ...
          <filter id="low-contrast" colorInterpolationFilters="sRGB">
            <feComponentTransfer>
