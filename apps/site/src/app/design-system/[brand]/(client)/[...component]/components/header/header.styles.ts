...
export const styles = tv(
  {
    slots: {
      base: 'bg-surface-hero sticky top-0 z-[1000] flex w-full items-center gap-2 px-2 py-2.5 antialiased transition-colors sm:px-4 md:-top-27 md:h-[14.25rem] md:items-end',
      ...
      title: 'text-text-mono typography-brand-7 pl-6 pt-[0.3125rem] font-normal focus:outline-none sm:pl-6 lg:pl-0',
