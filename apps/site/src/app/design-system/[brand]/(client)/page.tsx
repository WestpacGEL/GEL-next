      ...
      <Section background>
        ...
        <Grid>
          <SectionItem>
            ...
            <h3 className="border-b-border-hero text-text-heading typography-body-8 mb-5 border-b pb-2 font-bold">
      ...
      <Section>
        ...
        <Grid className="gap-y-4 text-left xsl:gap-x-5 sm:gap-x-8 md:gap-x-10">
          <GridItem span={{ initial: 10, xsl: 6, md: 5 }} start={{ initial: 2, md: 2 }} className="xsl:col-start-auto">
            <h3 className="border-border-muted-strong typography-body-8 border-b pb-3 font-bold sm:mb-2">Downloads</h3>
            <ul className="typography-body-10">
              <li className="border-border-muted-soft border-b">
                <Link
                  href="/articles/figma-libraries"
                  className="hover:text-text-primary box-border flex min-h-[3.4375rem] items-center justify-between py-4 outline-offset-[3px] outline-focus hover:underline sm:min-h-12 sm:py-1.5 sm:pr-1.5"
                >
                  Figma UI Kits
                  <FigmaLogo />
                </Link>
          ...
          <GridItem span={{ initial: 10, xsl: 6, md: 5 }} start={{ initial: 2 }} className="xsl:col-start-auto">
            <h3 className="border-border-muted-strong typography-body-8 border-b pb-3 font-bold sm:mb-2">Links</h3>
            <ul className="typography-body-10">
              <li className="border-border-muted-soft border-b">
                <Link
