    ...
    <div className="bg-gel-primary">
      <GridContainer fixed className="lg:!max-w-gel-lg-container lg:px-10">
        <Grid
          className={`
            gap-y-5 pt-5
            xsl:gap-y-6 xsl:pt-7
            sm:gap-y-7 sm:pt-9
            md:gap-y-10 md:pt-10
            lg:pt-11
          `}
        >
          <div
            className={`
              col-span-11 row-end-[span_1]
              xsl:col-span-9
            `}
          >
            <GELHeroLogo />
          ...
          <div
            className={`
              col-span-10 col-start-2 row-start-2 row-end-[span_1] mb-7
              xsl:col-span-9 xsl:col-start-3 xsl:mb-9
              sm:mb-14
              md:mb-15
              lg:mb-16
            `}
          >
            <p
              className={`
                font-gel-serif text-[1.125rem] leading-[1.33] text-text-mono
                antialiased
                sm:text-[1.5rem] sm:leading-[1.38]
              `}
            >
