...
import { PersonIcon } from '@westpac/ui/icon';
...
export default function PersonalCustomerPage() {
        ...
        beforeContent={
          <div className="mb-5 flex items-center gap-1">
            <Circle className="size-4 bg-surface-muted">
              <PersonIcon color="white-pale" size="xsmall" />
            </Circle>
            <h3 className="typography-body-11 font-semibold text-text-muted">Bella Harrison:</h3>
