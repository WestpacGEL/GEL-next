        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <h3
              ...
              `}
            >
              Built with Figma Code Connect + Figma MCP
            </h3>
            <p className="mb-5 typography-body-9 font-bold text-text-body">
              NOTE: These pages were built using the Figma MCP to test Figma Code Connect and the Figma MCP using the
              pattern library. They have been generated by AI and not touched manually to show capability so they may
              not look 100% correct to the design pattern.
            </p>
            <List type="link" className="flex flex-col gap-1">
              <Link href="/retrieve-application" passHref legacyBehavior>
                <ListItem className="flex flex-col gap-1 typography-body-9">Retrieve application</ListItem>
              </Link>
              <Link href="/confirm-profile" passHref legacyBehavior>
                <ListItem className="flex flex-col gap-1 typography-body-9">Confirm profile</ListItem>
              </Link>
              <Link href="/foreign-tax-residency" passHref legacyBehavior>
                <ListItem className="flex flex-col gap-1 typography-body-9">Foreign tax residency</ListItem>
              </Link>
            </List>
          </div>
        </div>
