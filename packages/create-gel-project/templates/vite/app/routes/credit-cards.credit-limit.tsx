...
export default function CreditLimit() {
  ...
  const onSubmit = useCallback(
    (formData: FormData) => {
      ...
      void navigate(`/credit-cards/name-and-contact${isFlattenRope ? '?flatten=true' : ''}`);
    },
  ...
  return (
    <div>
      {/* eslint-disable-next-line sonarjs/void-use */}
      <BackButton onClick={() => void navigate(`/credit-cards/home-life${isFlattenRope ? '?flatten=true' : ''}`)}>
        Back to Home life
      </BackButton>
      <CustomHeading
