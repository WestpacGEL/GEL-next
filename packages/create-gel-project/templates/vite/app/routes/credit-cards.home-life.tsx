...
export default function HomeLife() {
  ...
  const onSubmit = useCallback(
    (formData: FormData) => {
      ...
      void navigate(`/credit-cards/credit-limit${isFlattenRope ? '?flatten=true' : ''}`);
    },
  ...
  return (
    <div>
      {/* eslint-disable-next-line sonarjs/void-use */}
      <BackButton onClick={() => void navigate(`/credit-cards/loans-and-cards${isFlattenRope ? '?flatten=true' : ''}`)}>
