      ...
      {look === 'filled' ? (
        <Fragment>
          <path
            ...
            fill="currentColor"
          />
          <path d="M15 23V22H9V23C9 23.5523 9.44772 24 10 24H14C14.5523 24 15 23.5523 15 23Z" fill="currentColor" />
        </Fragment>
      ) : (
        <Fragment>
          <path
            ...
            fill="currentColor"
          />
          <path d="M15 22V23C15 23.5523 14.5523 24 14 24H10C9.44772 24 9 23.5523 9 23V22H15Z" fill="currentColor" />
        </Fragment>
      )}
    </Icon>
  );
