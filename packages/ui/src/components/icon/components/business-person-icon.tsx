      ...
      {look === 'filled' ? (
        <Fragment>
          ...
          <path
            ...
            fill="currentColor"
          />
          <path d="M8 15.4121C4.17331 16.1271 0 17.7708 0 20.3332V23.9999H8V15.4121Z" fill="currentColor" />
          <path d="M16 23.9999H24V20.3332C24 17.7708 19.8267 16.1271 16 15.4121V23.9999Z" fill="currentColor" />
        </Fragment>
      ) : (
        <Fragment>
          <path
