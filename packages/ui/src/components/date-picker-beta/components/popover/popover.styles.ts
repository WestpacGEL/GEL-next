    ...
    variants: {
      showAsBottomSheet: {
        true: {
          ...
          headerLabel: 'typography-body-10 text-body',
          closeButton:
        ...
        false: {
          underlay: '',
          closeButton:
            'pointer-events-none absolute right-0 top-0 size-5 -translate-y-1/2 translate-x-1/2 touch-none rounded-full border border-border-muted-mild bg-white opacity-0 focus:pointer-events-auto focus:touch-auto focus:opacity-100',
          headerLabel: 'hidden',
          popover:
