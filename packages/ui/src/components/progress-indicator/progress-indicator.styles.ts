...
export const styles = tv(
  {
    ...
    variants: {
      ...
      color: {
        ...
        white: { label: 'text-white[REPLACE TOKEN]' },
        black: { label: 'text-black[REPLACE TOKEN]' },
        background: { label: 'text-background[REPLACE TOKEN]' },
        border: { label: 'text-border[REPLACE TOKEN]' },
        borderDark: { label: 'text-borderDark[REPLACE TOKEN]' },
        focus: { label: 'text-focus[REPLACE TOKEN]' },
        heading: { label: 'text-text-heading' },
        hero: { label: 'text-text-hero' },
        light: { label: 'text-light[REPLACE TOKEN]' },
        link: { label: 'text-text-link' },
        muted: { label: 'text-text-muted' },
        neutral: { label: 'text-neutral[REPLACE TOKEN]' },
        pop: { label: 'text-pop[REPLACE TOKEN]' },
