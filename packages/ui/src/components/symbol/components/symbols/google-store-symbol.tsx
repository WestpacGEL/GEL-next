...
export const GoogleStoreSymbol = ({
  'aria-label': ariaLabel = 'Google Store',
  copyrightYear = '',
  viewBoxWidth = 170,
  viewBoxHeight = 50,
  className,
  ...
  <Symbol
    className={clsx('h-[50px] w-[170px]', className)}
  ...
  >
    ...
    <path d="M164 0H6a6 6 0 0 0-6 6v38a6 6 0 0 0 6 6h158a6 6 0 0 0 6-6V6a6 6 0 0 0-6-6z" fill="#a6a6a6" />
    ...
    />
    <path d="M34.2 30.5l-5.3-5.3-15.8 15.7a2.06 2.06 0 0 0 2.6.1l18.5-10.5" fill="url(#GoogleStoreSymbol-c)" />
    <path d="M34.2 19.8L15.8 9.4a2.06 2.06 0 0 0-2.6.1l15.7 15.7z" fill="url(#GoogleStoreSymbol-d)" />
    <path
