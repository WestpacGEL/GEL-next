...
export const styles = tv(
  {
    ...
    variants: {
      size: {
        small: { base: 'typography-body-10 px-2 pb-[0.25rem] pt-[0.1875rem] on-theme-rams:before:h-[0.0625rem]' },
        medium: { base: 'typography-body-9 px-2 py-[0.3125rem] on-theme-rams:before:h-[0.125rem]' },
        large: { base: 'typography-body-9 px-[0.9375rem] py-[0.5rem] on-theme-rams:before:h-[0.1875rem]' },
        xlarge: { base: 'typography-body-8 px-3 pb-[0.625rem] pt-[0.5625rem] on-theme-rams:before:h-[0.25rem]' },
      },
      look: {
        primary: {
          base: 'relative border border-primary bg-primary text-white hover:bg-primary-70 active:bg-primary-50 on-theme-rams:border-b-pop on-theme-rams:before:absolute on-theme-rams:before:bottom-0 on-theme-rams:before:block on-theme-rams:before:w-full on-theme-rams:before:bg-pop',
        },
