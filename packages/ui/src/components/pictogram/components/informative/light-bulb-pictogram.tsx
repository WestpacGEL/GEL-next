...
export function LightBulbPictogram({
  mode = 'duo',
  viewBoxWidth = 78,
  viewBoxHeight = 78,
    ...
    >
      <g fill="none" fillRule="evenodd">
        <polygon
          ...
          points="37.313 11.15 39.813 11.15 39.813 2.001 37.313 2.001"
        />
        <polygon
          className={fill({ mode, highlight: true })}
          points="61.976 33.873 71.126 33.873 71.126 31.373 61.976 31.373"
        />
        <polygon className={fill({ mode, highlight: true })} points="6 33.873 15.15 33.873 15.15 31.373 6 31.373" />
        <polygon
          className={fill({ mode, highlight: true })}
          points="57.47 48.209 63.94 54.679 65.707 52.911 59.238 46.441"
        />
        <polygon
          className={fill({ mode, highlight: true })}
