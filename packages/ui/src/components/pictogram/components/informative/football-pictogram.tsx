...
export function FootballPictogram({
  mode = 'duo',
  viewBoxWidth = 78,
  viewBoxHeight = 78,
  'aria-label': ariaLabel = 'Football',
  copyrightYear = '2021',
  className,
  ...props
}: PictogramProps) {
  return (
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <polygon
          className={fill({ mode, highlight: true })}
          points="40.121 42.24 33.046 35.165 35.167 33.044 42.242 40.119"
        />
        <polygon
          className={fill({ mode, highlight: true })}
          points="44.8 37.562 37.724 30.487 39.846 28.366 46.92 35.441"
        />
        <polygon
          className={fill({ mode, highlight: true })}
