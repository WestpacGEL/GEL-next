...
export function TaxDocumentPictogram({
  mode = 'duo',
  viewBoxWidth = 78,
  viewBoxHeight = 78,
  'aria-label': ariaLabel = 'Tax document',
  copyrightYear = '2021',
  className,
  ...props
}: PictogramProps) {
  return (
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <polygon
          className={fill({ mode, outline: true })}
          points="18.655 42.92 50.317 42.92 50.317 39.92 18.655 39.92"
        />
        <polygon
          className={fill({ mode, outline: true })}
          points="18.655 51.218 50.317 51.218 50.317 48.218 18.655 48.218"
        />
        <polygon
          className={fill({ mode, outline: true })}
          points="18.655 59.515 38.682 59.515 38.682 56.515 18.655 56.515"
        />
        <polygon
