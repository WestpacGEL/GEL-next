...
export function MedicareCardPictogram({
  mode = 'duo',
  viewBoxWidth = 78,
  viewBoxHeight = 78,
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <polygon
          ...
          points="17.385 44.555 50.385 44.555 50.385 41.555 17.385 41.555"
        />
        <polygon
          className={fill({ mode, outline: true })}
          points="10.385 51.544 46.385 51.544 46.385 48.544 10.385 48.544"
        />
        <path
          className={fill({ mode, outline: true })}
