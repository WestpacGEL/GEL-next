...
export function MovieTicketsPictogram({
  mode = 'duo',
  viewBoxWidth = 78,
  viewBoxHeight = 78,
  'aria-label': ariaLabel = 'Movie tickets',
  copyrightYear = '2021',
  className,
  ...props
}: PictogramProps) {
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <polygon
          ...
          points="27.249 52.284 33.16 56.902 34.699 54.931 28.788 50.314"
        />
        <polygon
          className={fill({ mode, outline: true })}
          points="18.805 45.689 24.716 50.306 26.255 48.336 20.344 43.719"
        />
        <path
          className={fill({ mode, outline: true })}
