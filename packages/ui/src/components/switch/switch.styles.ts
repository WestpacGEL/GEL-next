...
export const styles = tv({
  slots: {
    ...
    switchDiv:
      'relative box-content overflow-hidden border border-border-muted-strong transition duration-[.3s] after:absolute after:top-0 after:left-0 after:block after:rounded-full after:transition-all after:duration-[.3s]',
