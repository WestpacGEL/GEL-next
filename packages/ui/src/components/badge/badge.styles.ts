...
export const styles = tv(
  {
    ...
    variants: {
      color: {
        ...
        neutral: 'border-border-grey-dark bg-surface-muted-vivid text-text-mono',
        ...
        'faint-inverted': 'bg-surface-faint-faint border-none text-text-muted',
        ...
        'neutral-inverted': 'bg-surface-neutral-faint border-none text-text-body',
