...
/**
 * Examples for all colors/shades
 */
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <div className="w-22" />
        {TINTS.map(tint => (
          <div key={tint} className="flex w-12 items-center justify-center rounded">
            {tint}
          </div>
        ))}
      </div>
        ...
        <div key={color} className="flex items-center gap-2">
          ...
          {tints.map(tint => {
            return (
              <div
                key={tint}
                className={`${tint} flex h-7 w-12 items-center justify-center rounded transition-colors`}
              />
            );
          })}
        </div>
