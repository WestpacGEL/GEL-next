  ...
  render: () => (
    <div className="p-10">
      ...
      <p className="py-2 typography-body-9">
        ...
        <code className="border border-border-muted-mild bg-background-pale">!focus-outline</code> to override
        ...
        <code className="border border-border-muted-mild bg-background-pale">form-control</code> styling and
